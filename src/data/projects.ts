...
export const projectsData: Project[] = [
  {
    id: 'salud-infantil',
    title: 'SegEm - Dashboard integral para Control de Embarazadas',
    subtitle: 'Ministerio de Salud / IMI Corrientes',
    description: 'Plataforma centralizada y segura desarrollada de punta a punta para el seguimiento clínico de embarazadas en entornos de alto riesgo, orientada a la organización de centros de salud.',
    impact: 'Automatiza el listado de seguimiento, visualiza automáticamente la ausencia de controles (+30 días) y optimiza la búsqueda activa territorial de las madres.',
  ...
  {
    id: 'ficha-tesis',
    title: 'Fichá: Auditoría de Precios con Agentes de IA en Corrientes ',
  ...
  },
  {
    ...
    description: 'Diseño, implementación y mantenimiento del pipeline de extracción, transformación y carga de datos diversos. Centraliza flujos de ingesta de datos tanto manuales como scripts automáticos programados.',
